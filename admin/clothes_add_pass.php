...
$sql_add="insert into clothes (title,comefrom,pubdate,thumbnail,keywords,description,content,posid) values(?,?,?,?,?,?,?,?)";
...
echo "<script>alert('添加成功！');window.location.href='clothes_list.php';</script>";
$dbh = null;
?>
</body>
</html>

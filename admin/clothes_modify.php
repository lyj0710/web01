...
<div class="container-fluid">
    <h4>修改产品</h4>
    <form id="form1" name="form1" method="post" action="clothes_modify_pass.php?id=<?=$rs['id']?>" >
        ...
        <div class="input-group mb-3">
            <div class="input-group-append  col-md-2">
            <label for="thumbnail">缩略图：</label></div>
        ...
        <div class="input-group mb-3">
            <div class="input-group-append  col-md-2">
            <label class="form-check-label">首页推荐：</label>
                <input type="checkbox" class="form-check-input" id="posid" name="posid[]" style="margin-left:75px;" value="setindex"
                    <?php
